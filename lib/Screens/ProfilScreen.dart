...
class _ProfilScreenState extends State<ProfilScreen> {
  ...
  void initState() {
    ...
    setState(() {
      currentUser =
          _firestoreService.getCurrentUser(); // recuperation de l'utilisateur courant lors de la connexion
    });
  }
  ...
  void handleDisconnect() {
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(
            builder: (context) => const LoginScreen(title: "SquadGather")));
  }
            ...
            child: Column(
              children: <Widget>[
                ...
                InputWidget(
                    ...
                    obscureText: false,
                    readOnly: true,
                    currentValue: currentUser.login,
                ...
                InputWidget(
                    ...
                    currentValue: currentUser.password,
                    type: TextInputType.text),
                const Padding(padding: EdgeInsets.only(top: 10)),
                InputWidget(
                ...
                InputWidget(
                    ...
                    currentValue: currentUser.postalCode,
